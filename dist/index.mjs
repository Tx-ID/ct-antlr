...
var JakselLISPParser = class _JakselLISPParser extends Parser {
  static T__0 = 1;
  static T__1 = 2;
  static T__2 = 3;
  static T__3 = 4;
  ...
  static VOCABULARY = new VocabularyImpl(_JakselLISPParser._LITERAL_NAMES, _JakselLISPParser._SYMBOLIC_NAMES, []);
  // @Override
  // @NotNull
  get vocabulary() {
  ...
  constructor(input) {
    super(input);
    this._interp = new ParserATNSimulator(_JakselLISPParser._ATN, this);
  }
  // @RuleVersion(0)
  program() {
  ...
  static get _ATN() {
    if (!_JakselLISPParser.__ATN) {
      _JakselLISPParser.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(_JakselLISPParser._serializedATN));
    }
...
var ExpressionContext = class _ExpressionContext extends ParserRuleContext {
  ATOM() {
...
import { ATNDeserializer as ATNDeserializer2 } from "antlr4ts/atn/ATNDeserializer";
import { Lexer } from "antlr4ts/Lexer";
import { LexerATNSimulator } from "antlr4ts/atn/LexerATNSimulator";
import { VocabularyImpl as VocabularyImpl2 } from "antlr4ts/VocabularyImpl";
import * as Utils2 from "antlr4ts/misc/Utils";
var JakselLISPLexer = class _JakselLISPLexer extends Lexer {
  static T__0 = 1;
  static T__1 = 2;
  static T__2 = 3;
  static T__3 = 4;
  ...
  static VOCABULARY = new VocabularyImpl2(_JakselLISPLexer._LITERAL_NAMES, _JakselLISPLexer._SYMBOLIC_NAMES, []);
  // @Override
  // @NotNull
  get vocabulary() {
  ...
  constructor(input) {
    super(input);
    this._interp = new LexerATNSimulator(_JakselLISPLexer._ATN, this);
  }
  // @Override
  get grammarFileName() {
    return "JakselLISP.g4";
  ...
  static get _ATN() {
    if (!_JakselLISPLexer.__ATN) {
      _JakselLISPLexer.__ATN = new ATNDeserializer2().deserialize(Utils2.toCharArray(_JakselLISPLexer._serializedATN));
    }
